...
from src.Shift import get_parse, get_shift, get_answer, create_doves


@pytest.mark.parametrize(('first', 'second', 'parser'), [('3 10', '10 45 50', {
        'count': '3',
        'distance': '10',
        'speeds': ['10', '45', '50']
    })])
...
@pytest.mark.parametrize(('count', 'distance', 'speeds', 'doves'), [('3', '10', ['10', '45', '50'], [
                                                    Dove(10, 0),
                                                    Dove(45, 1),
                                                    Dove(50, 2)
                                                ])])
...
@pytest.mark.parametrize(('doves', 'result'), [([
                                                    Dove(10, 0),
                                                    Dove(45, 1),
                                                    Dove(50, 2)
                                                ], 0)])
